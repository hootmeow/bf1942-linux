...
#
#  Usage:
#    Interactive: sudo ./ubu_22.04_bfsmd_setup.sh [instance_name]
#    Unattended:  sudo ./ubu_22.04_bfsmd_setup.sh <instance_name> --yes [options]
#    All options: sudo ./ubu_22.04_bfsmd_setup.sh --help
#
...
if [ -f /etc/os-release ]; then
    . /etc/os-release
    if [ "$ID" != "ubuntu" ]; then
        log_warn "This script is intended for Ubuntu. Detected: ${PRETTY_NAME:-unknown}"
...
echo ""
echo -e "${C_ARMY}   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "   ${YELLOW}★${NC} ${BOLD}BATTLEFIELD 1942 · DEDICATED SERVER${NC} ${YELLOW}★${NC}  ${C_STEEL}[Ubuntu 22.04]${NC}"
...
if [ ! -f "/etc/bf1942_deps_installed" ]; then
    ...
    apt-get install -y --no-install-recommends \
        ...
        zlib1g:i386 libcurl4:i386 libxext6:i386 \
